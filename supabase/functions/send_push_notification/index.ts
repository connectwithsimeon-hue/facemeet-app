  ...
  try {
    ...
    if (
      ...
      return new Response(
        JSON.stringify({
          ...
          target_equals_sender: true,
          self_notification_suppressed: true,
          target_native_token_count: 0,
          target_web_subscription_count: 0,
    ...
    if (error) {
      ...
      return new Response(
        JSON.stringify({
          ...
          target_user_short: shortId(targetUserId),
          sender_user_short: shortId(senderUserId),
          target_equals_sender: senderUserId === targetUserId,
    ...
    return new Response(
      JSON.stringify({
        ...
        target_equals_sender: senderUserId === targetUserId,
        self_notification_suppressed: false,
        target_native_token_count: nativeTokensFound,
        target_web_subscription_count: webSubscriptionsFound,
        android_push_target_token_count: androidTokensFound,
        fcm_attempted: nativeTokensFound > 0 && hasNativeConfig,
        ...
        web_push_attempted: webSubscriptionsFound > 0,
        web_push_success_count: webSent,
        web_sent: webSent,
